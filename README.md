...
As of v3.11.3, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
```bash
go install github.com/livecodelife/linespec/cmd/linespec@v3.11.3
```
...
**LineSpec v3.11.3** - Built with Provenance Records
