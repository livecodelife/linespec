...
infrastructure:
  ...
  proxy_image: "ghcr.io/livecodelife/linespec:3.19.0" # Override the proxy image (default: local linespec:latest if present, else the published image pinned to your version)
