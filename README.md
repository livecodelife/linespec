...
As of v2.5.0, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
```bash
go install github.com/livecodelife/linespec/cmd/linespec@v2.5.0
```
...
**LineSpec v2.5.0** - Built with Provenance Records
