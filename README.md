...
As of v3.11.7, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
**LineSpec v3.11.7** - Built with Provenance Records
