...
As of v2.2.0, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
**LineSpec v2.2.0** - Built with Provenance Records
