...
[![Version](https://img.shields.io/badge/version-3.17.0-blue.svg)](https://github.com/livecodelife/linespec/releases)
...
As of v3.17.0, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
```bash
go install github.com/livecodelife/linespec/v3/cmd/linespec@v3.17.0
```
...
- `linespec_3.17.0_*` - Full release (Provenance Records + LineSpec Testing)
...
**LineSpec v3.17.0** - Built with Provenance Records
