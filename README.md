...
As of v3.10.1, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
```bash
go install github.com/livecodelife/linespec/cmd/linespec@v3.10.1
```
...
**LineSpec v3.10.1** - Built with Provenance Records
