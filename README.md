...
As of v3.3.1, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
**LineSpec v3.3.1** - Built with Provenance Records
