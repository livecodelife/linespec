...
[![Version](https://img.shields.io/badge/version-3.16.0-blue.svg)](https://github.com/livecodelife/linespec/releases)
...
As of v3.16.0, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
- `linespec_3.16.0_*` - Full release (Provenance Records + LineSpec Testing)
...
**LineSpec v3.16.0** - Built with Provenance Records
