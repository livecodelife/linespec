...
As of v3.10.3, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
**LineSpec v3.10.3** - Built with Provenance Records
