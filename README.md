...
As of v3.8.0, **LineSpec Testing** is stable and included in the default installation alongside Provenance Records.
...
```bash
go install github.com/livecodelife/linespec/cmd/linespec@v3.8.0
```
...
**LineSpec v3.8.0** - Built with Provenance Records
